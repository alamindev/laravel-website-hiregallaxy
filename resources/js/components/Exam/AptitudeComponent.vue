          ...
          <div class="col-lg-6">
            <div class="hiregallaxy_left__side text-left">
              ...
              >
                ...
                <button
                  :disabled="question != ''"
                  class="btn btn-success hiregallaxy_custom_btn d-flex justify-content-center ml-4 align-items-center"
                  @click="SkipQuestion(questionIndex)"
                >
                  Skip for now
                </button>
              </div>
              ...
              <p class="hiregallaxy__question m-0 font-weight-bold">
                ...
                <span
                  ...
                  v-html="quiz.questions[questionIndex].questions"
                ></span>
              </p>
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    fetchData() {
      Axios.get("/candidates/aptitude/questions/" + this.id).then(
        async (res) => {
